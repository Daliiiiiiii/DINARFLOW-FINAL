    ...
    <section className="min-h-screen pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 relative">
        ...
        >
          ...
          >
            Send and receive TND instantly, or convert to USDT for enhanced financial opportunities. The future of Tunisian digital finance is here.
          </motion.p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            {
              title: "USDT Trading",
              description: "Trade TND for USDT and access new financial opportunities in our ecosystem.",
              delay: 0.8,
              translateY: [-10, 10]
            }
          ].map((card, index) => (
