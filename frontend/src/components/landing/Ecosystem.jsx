  ...
  const features = [
    {
      ...
      title: "DFLOW Staking",
      description: "Earn rewards by staking your DFLOW tokens in our ecosystem",
      comingSoon: false
    },
    {
      icon: <ShoppingBag className="w-8 h-8" />,
      title: "Merchant Payments",
      description: "Pay at local stores using DinarFlow or DFLOW tokens",
      comingSoon: true
    },
    {
      ...
      <div className="container mx-auto relative">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Explore the growing ecosystem of services powered by DFLOW
          </p>
        </motion.div>
