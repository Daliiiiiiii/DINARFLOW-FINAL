...
const HowItWorks = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "Trade USDT",
      description: "Convert your TND to USDT and unlock new financial opportunities. Trade, stake, and earn rewards in our growing ecosystem.",
  ...
  return (
    <section 
      ref={containerRef}
      className="min-h-[400vh] relative py-20 bg-gradient-to-b from-gray-950 to-gray-900"
    >
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        <div className="container mx-auto px-4 md:px-8 lg:px-12 relative">
          ...
          {steps.map((step, index) => {
            const startProgress = 0.2 + (index * 0.2);
