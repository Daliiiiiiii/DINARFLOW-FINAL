          ...
          <div className="flex flex-col gap-4">
            <div className="relative">
              <input
                ...
                className={`w-full ${i18n.language === 'ar' ? 'pr-10 pl-4' : 'pl-10 pr-4'} py-2.5 rounded-lg border ${
                  isDark
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex-1 min-w-[200px] relative">
                ...
                >
                  <option value="all">{t('admin.kycStatus.all')}</option>
                  ...
                  <option value="unverified">{t('admin.kycStatus.unverified')}</option>
                </select>
                <div className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none">
              ...
              <div className="flex-1 min-w-[200px] relative">
                ...
                >
                  ...
                  <option value="name">{t('admin.sort.nameAZ')}</option>
                  <option value="name-desc">{t('admin.sort.nameZA')}</option>
                </select>
                <div className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none">
          ...
          <table className="w-full">
            <thead>
              <tr className={`text-sm ${i18n.language === 'ar' ? 'text-right' : 'text-left'} ${isDark ? 'bg-gray-800/50' : 'bg-gray-50'}`}>
                ...
                <th className="px-6 py-4 font-medium text-gray-500 dark:text-gray-400">{t('admin.contact')}</th>
                <th className="px-6 py-4 font-medium text-gray-500 dark:text-gray-400">{t('admin.idNumber')}</th>
                <th className="px-6 py-4 font-medium text-gray-500 dark:text-gray-400">{t('admin.accountStatus')}</th>
                <th className="px-6 py-4 font-medium text-gray-500 dark:text-gray-400">{t('admin.kycStatusLabel')}</th>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {user.accountStatus === 'suspended' ? (
                          <button
                            ...
                            title={t('admin.unsuspendAccount')}
                          >
