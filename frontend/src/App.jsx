...
import Maintenance from './contexts/Maintenance'
...
const AppContent = () => {
  ...
  if (loading || !appReady || notificationLoading || maintenanceLoading) {
    return <LoadingSpinner />
  }

  // Show maintenance page for all users except superadmin when maintenance mode is active
  if (isMaintenanceMode && currentUser?.role !== 'superadmin') {
    return <Maintenance />
  }
